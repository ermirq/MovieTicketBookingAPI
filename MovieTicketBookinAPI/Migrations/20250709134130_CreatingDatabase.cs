    ...
    public partial class CreatingDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingSeats", x => new { x.BookingId, x.ShowtimeId, x.SeatId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingSeats_ShowtimeSeats_ShowtimeId_SeatId",
            ...
            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "Id", "Description", "DurationInMinutes", "Genre", "PosterUrl", "Title" },
                values: new object[,]
                {
                    { 1, "A mind-bending thriller", 148, "Sci-Fi", "", "Inception" },
                    { 2, "A hacker discovers the true nature of reality", 136, "Action", "", "The Matrix" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Downtown", "Cineplex 1" },
                    { 2, "Uptown", "Cineplex 2" }
                });

            migrationBuilder.InsertData(
                table: "Showtimes",
                columns: new[] { "Id", "MovieId", "StartTime", "CinemaId" },
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 10, 1, 14, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 2, 2, new DateTime(2023, 10, 1, 16, 0, 0, 0, DateTimeKind.Unspecified), 2 }
                });
